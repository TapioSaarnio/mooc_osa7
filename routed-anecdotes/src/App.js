...
const Menu = ({anecdotes, setNotification, addNew}) => {
...
const CreateNew = (props) => {
  ...
  const returnAllExceptReset = (allValues) => {
    const allExceptReset = {
      type: allValues.type,
      value: allValues.value,
      onChange: allValues.onChange
    }

    return allExceptReset
  }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input {...returnAllExceptReset(content)} />
        </div>
        <div>
          author
          <input {...returnAllExceptReset(author)} />
        </div>
        <div>
          url for more info
          <input {...returnAllExceptReset(info)} />
        </div>
